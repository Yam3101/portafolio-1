  ...
  return (
    <>
      ...
      <div className='pt-16 grid place-items-center justify-center'>
        <h1 className='my-name-animation font-teachers text-2xl font-medium'>ANGEL YAM</h1>
        ...
        <div className="grid justify-center place-items-center">
          <h3 className='animated-dev-tools m-o mt-14 text-center font-reem text-4xl font-bold'>DEVELOPMENT TOOLS AND SOFTWARE</h3>
          <Tools />
        </div>
      </div>
      <Footer />
